...
public:
    ...
    {
        actionServer =
            rclcpp_action::create_server<DoGSL>(this, name, std::bind(&CGSLServer::handle_goal, this, _1, _2),
                                                std::bind(&CGSLServer::handle_cancel, this, _1), std::bind(&CGSLServer::handle_accepted, this, _1));
    }
