...
namespace GSL::Utils::Colors
{
    ...
    inline auto _magma_data = std::to_array<std::array<float, 3>>({{0.001462, 0.000466, 0.013866},
    ...
    inline auto _inferno_data = std::to_array<std::array<float, 3>>({{0.001462, 0.000466, 0.013866},
    ...
    inline auto _plasma_data = std::to_array<std::array<float, 3>>({{0.050383, 0.029803, 0.527975},
    ...
    inline auto _viridis_data = std::to_array<std::array<float, 3>>({{0.267004, 0.004874, 0.329415},
    ...
    inline auto _jet_data = std::to_array<std::array<float, 3>>({
        {0, 0, 0.5156},
        {0, 0, 0.5312},
        {0, 0, 0.5469},
        {0, 0, 0.5625},
    ...
    inline auto _cividis_data = std::to_array<std::array<float, 3>>({
    ...
    inline const std::array<std::array<float, 3>, 256UL>& GetColorMap(ColorMaps map)
    {
        switch (map)
        {
    ...
    inline std::array<float, 3> SampleColorMap(float t, ColorMaps map)
    {
