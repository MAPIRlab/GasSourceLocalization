...
namespace GSL
{
    ...
    public:
        ...
        static void VisualizeMarkers(Grid2D<GrGSL_internal::Cell> grid, GrGSL_internal::Markers& markers, rclcpp::Node::SharedPtr node, Vector2 colorScaleLimits);
        static void VisualizeMarkers(Grid2D<double> grid, GrGSL_internal::Markers& markers, rclcpp::Node::SharedPtr node, Vector2 colorScaleLimits);
        ...
        static inline bool debuggingPropagation = false;
    };
}